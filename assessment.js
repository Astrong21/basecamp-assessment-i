...
let notHakeem = myName!='Hakeem Olajuwan'
...
var responseCreator = function(param){
  if (param=='green'){return 'Green is okay'} else if (param=='red'){return'I heart red'} else {return'What is your favorite color?'};
}

// #9 Create a function called 'sum' that takes in one parameter and returns the sum of that parameter added it itself.

function sum(num){ return 2*num};
